$(document).ready(function () {
  ...
  $("#search").keyup(function (e) {
    if ($("#search").val()) {
      ...
      $.ajax({
        type: "GET",
        url: "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-search.php",
        data: { search },
  ...
  $("#name").keyup(function (e) { 
    if ($("#name").val()) {
      ...
      $.ajax({
        type: "GET",
        url: "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-insertbyname.php",
        data: { name },
        success: function (response) {
          console.log(response);
          let productos = JSON.parse(response);
  ...
  $("#product-form").submit(function (e) {
    ...
    let url =
      editar == false
        ? "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-add.php"
        : "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-edit.php";
  ...
  function listarProductos() {
    $.ajax({
      type: "GET",
      url: "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-list.php",
      success: function (response) {
        let productos = JSON.parse(response);
  ...
  $(document).on("click", ".product-delete", function () {
    if (confirm("Estas seguro de querer eliminarlo?")) {
      ...
      $.ajax({
        type: "GET",
        url: "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-delete.php",
        data: { id },
        success: function (response) {
          listarProductos();
          let respuesta = JSON.parse(response);
  ...
  $(document).on("click", ".product-item", function () {
    ...
    let id = $(element).attr("productId");
    $.get(
      "http://localhost:3000/practicas/p09/p09_base/p09_con_jquery%20-%20complemento/product_app/backend/product-single.php",
      { id },
      function (response) {
